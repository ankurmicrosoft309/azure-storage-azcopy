...
$manifest = @(
    @{
        ...
        X = 0; Y = 0; W = 22; H = 5
        MarkdownText = @"
This dashboard adapts the useful data-volume views from Storage Mover to AzCopy job telemetry, then enriches destination account names server-side. Estimated totals apply inverse `SamplingRate` weighting. Resumed jobs are rolled up once by `JobID` using the latest observed finish and maximum cumulative counters.
...
"@
    ...
    @{
        ...
        Visual = "multistat"
        Description = "Observed unique JobIDs plus inverse-sampling estimates for jobs, logical payload bytes, and completed payload objects in the selected range."
        X = 0; Y = 5; W = 22; H = 6
    },
    @{
    ...
    @{
        Title = "Monthly estimated data transferred"
        File = "queries/tiles/03_monthly_data_trend.kql"
        Visual = "timechart"
        Description = "Logical successful payload bytes, inverse-weighted by SamplingRate and grouped by the latest observed job finish month."
        X = 0; Y = 17; W = 11; H = 8
    },
    @{
        Title = "Monthly estimated completed objects"
        File = "queries/tiles/04_monthly_objects_trend.kql"
        Visual = "timechart"
        Description = "Completed payload objects excluding folder-property operations, inverse-weighted by SamplingRate."
        X = 11; Y = 17; W = 11; H = 8
    },
    @{
        Title = "Estimated data by source-target pair"
        File = "queries/tiles/05_data_by_source_target.kql"
        Visual = "bar"
        Description = "Estimated logical payload volume grouped by AzCopy source and destination service type."
        X = 0; Y = 25; W = 11; H = 8
    },
    @{
        Title = "Estimated completed objects by source-target pair"
        File = "queries/tiles/06_objects_by_source_target.kql"
        Visual = "bar"
        Description = "Estimated completed payload objects grouped by AzCopy source and destination service type."
        X = 11; Y = 25; W = 11; H = 8
    },
    @{
        Title = "Estimated data by destination service type"
    ...
    @{
        Title = "Estimated data by source mount type"
        File = "queries/tiles/08_data_by_source_mount.kql"
        Visual = "bar"
        Description = "Estimated logical payload volume grouped by source classification such as local disk, NAS SMB/NFS, or cloud."
        X = 11; Y = 33; W = 11; H = 8
    },
    @{
        Title = "Estimated data by destination endpoint kind"
    ...
    @{
        Title = "Estimated data by telemetry-sender country/region"
    ...
    @{
        ...
        Visual = "table"
        Description = "Latest 200 unique JobIDs after all filters. Values are observed cumulative job counters, not sampling estimates."
        X = 0; Y = 49; W = 22; H = 10
    },
    @{
        Title = "Estimated data by destination Storage account kind"
    ...
    @{
        Title = "Estimated data by destination Storage SKU"
    ...
    @{
        Title = "Estimated data by destination redundancy"
    ...
    @{
        Title = "Estimated data by destination namespace"
    ...
    @{
        Title = "Estimated data by destination access tier"
    ...
    @{
        Title = "Estimated data by destination account class"
    ...
    @{
        ...
        Visual = "table"
        Description = "Weighted jobs and data retained in mapped, missing, and not-applicable buckets for each inventory."
        X = 0; Y = 83; W = 22; H = 8
    }
)
