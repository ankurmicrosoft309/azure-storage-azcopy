...
| Data Transferred through completed jobs | Included | Selected-range estimated logical bytes from deduplicated terminal jobs |
...
| Monthly Data transferred | Included | Monthly estimated logical payload trend |
...
| Total Data transferred | Included | Estimated selected-range logical payload |
...
| InProgress Job runs | Excluded | Started-minus-finished is not authoritative under sampling and cross-range boundaries |
...
| Activity split by Source Target | Included | Estimated data by `FromTo` |
...
| Total data by recurring customers | Included with corrected identity wording | Estimated data from recurring installations |
...
- Missing inventory joins are shown as `Unknown`, `Unmapped`, or explicit
  coverage states.
- Sampling-adjusted additive metrics are estimates; distinct installation
  counts remain observed counts.
