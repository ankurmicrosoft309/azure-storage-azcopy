...
| project Metrics = pack_array(
    ...
    pack('Metric', 'Estimated data (TB)', 'Value', round(EstimatedBytes / 1e12, 3)),
    pack('Metric', 'Estimated completed objects', 'Value', round(EstimatedObjects, 0)))
| mv-expand Metrics
...
$definitions = @(
    @{
        ...
        Panels = @(
            ...
            @{
                Title = "Daily terminal job activity"; Visual = "timechart"; Description = "Estimated terminal jobs by status."
...
{{ADAPTATION_FILTERS}}
FilteredJobs
| summarize EstimatedJobs = round(sum(Weight), 2) by timestamp = bin(EndTime, 1d), JobStatus
| order by timestamp asc
'@
            },
            @{
                Title = "Terminal outcomes"; Visual = "bar"; Description = "Estimated terminal jobs grouped by final status."
...
{{ADAPTATION_FILTERS}}
FilteredJobs
| summarize EstimatedJobs = round(sum(Weight), 2) by JobStatus
| order by EstimatedJobs desc
'@
            },
            @{
                Title = "Estimated data by source-target pair"; Visual = "bar"; Description = "Logical bytes grouped by AzCopy topology."
...
{{ADAPTATION_FILTERS}}
FilteredJobs
| summarize EstimatedBytes = sum(Weight * BytesTransferred) by FromTo
| project FromTo, EstimatedDataGB = round(EstimatedBytes / 1e9, 3)
| order by EstimatedDataGB desc
'@
            },
            @{
    ...
    @{
        ...
        Panels = @(
            @{
                Title = "How to read this dashboard"; Visual = "markdownCard"; Description = ""
                X = 0; Y = 0; W = 22; H = 4
                MarkdownText = "This is an observed selected-range behavior funnel, not an acquisition, installation, or lifetime customer funnel. Counts are distinct pseudonymous InstallationID values and are intentionally not inverse-sampling estimates."
            },
            @{
...
| summarize
    ...
    EstimatedAttemptedDataGB = round(sum(Weight * BytesTransferred) / 1e9, 3),
    arg_max(EndTime, JobErrorCode)
  by InstallationID
| where SuccessJobs == 0 and TerminalJobs > 0
| project InstallationID, FirstObserved, LastObserved, TerminalJobs, FailedJobs, EstimatedAttemptedDataGB, LatestErrorCode = JobErrorCode
    ...
    @{
        ...
        Panels = @(
            @{
                Title = "How to read this dashboard"; Visual = "markdownCard"; Description = ""
                X = 0; Y = 0; W = 22; H = 5
                MarkdownText = "Recurring means activity in at least two calendar months within the selected range. Counts are observed pseudonymous installations or destination account proxies, not canonical customers. Estimated bytes retain SamplingRate weighting."
            },
            @{
...
| summarize ActiveMonths = dcount(startofmonth(EndTime)), EstimatedBytes = sum(Weight * BytesTransferred) by InstallationID
...
let RecurringBytes = toscalar(Installations | summarize sum(EstimatedBytes));
...
print Metrics = pack_array(
    ...
    pack('Metric', 'Estimated recurring data (TB)', 'Value', round(RecurringBytes / 1e12, 3)),
...
'@
            ...
            @{
                Title = "Monthly recurring data"; Visual = "timechart"; Description = "Estimated bytes from installations active after their first observed month."
...
| join kind=inner Firsts on InstallationID
| where Month > FirstMonth
| summarize EstimatedBytes = sum(Weight * BytesTransferred) by timestamp = Month
| order by timestamp asc
'@
            },
            @{
...
| summarize
  ...
  by InstallationID
| where ActiveMonths >= 2
| order by ActiveMonths desc, EstimatedDataTB desc
| take 500
'@
            }
        )
...
$dataManifest = @(
    ...
    @{ Title = "Monthly estimated completed objects"; Path = "queries\tiles\04_monthly_objects_trend.kql"; Visual = "timechart"; Description = "Estimated completed payload objects by month."; X = 11; Y = 17; W = 11; H = 8 },
    @{ Title = "Estimated data by source-target pair"; Path = "queries\tiles\05_data_by_source_target.kql"; Visual = "bar"; Description = "Estimated data grouped by FromTo."; X = 0; Y = 25; W = 11; H = 8 },
    @{ Title = "Estimated completed objects by source-target pair"; Path = "queries\tiles\06_objects_by_source_target.kql"; Visual = "bar"; Description = "Estimated completed objects grouped by FromTo."; X = 11; Y = 25; W = 11; H = 8 },
    @{ Title = "Estimated data by destination service type"; Path = "queries\tiles\07_data_by_destination_type.kql"; Visual = "bar"; Description = "Estimated data grouped by AzCopy destination service type."; X = 0; Y = 33; W = 11; H = 8 },
    @{ Title = "Estimated data by source mount type"; Path = "queries\tiles\08_data_by_source_mount.kql"; Visual = "bar"; Description = "Estimated data grouped by source mount classification."; X = 11; Y = 33; W = 11; H = 8 },
    @{ Title = "Estimated data by destination endpoint kind"; Path = "queries\tiles\09_data_by_destination_endpoint.kql"; Visual = "bar"; Description = "Destination hostname classification."; X = 0; Y = 41; W = 11; H = 8 },
    @{ Title = "Estimated data by telemetry-sender country/region"; Path = "queries\tiles\10_data_by_client_region.kql"; Visual = "bar"; Description = "Application Insights sender-IP geography."; X = 11; Y = 41; W = 11; H = 8 },
    ...
    @{ Title = "Estimated data by destination Storage account kind"; Path = "queries\tiles\12_data_by_storage_kind.kql"; Visual = "bar"; Description = "Current ARM account kind."; X = 0; Y = 59; W = 11; H = 8 },
    @{ Title = "Estimated data by destination Storage SKU"; Path = "queries\tiles\13_data_by_storage_sku.kql"; Visual = "bar"; Description = "Current ARM SKU."; X = 11; Y = 59; W = 11; H = 8 },
    @{ Title = "Estimated data by destination redundancy"; Path = "queries\tiles\14_data_by_storage_redundancy.kql"; Visual = "bar"; Description = "Historical XStore redundancy."; X = 0; Y = 67; W = 11; H = 8 },
    @{ Title = "Estimated data by destination namespace"; Path = "queries\tiles\15_data_by_storage_namespace.kql"; Visual = "bar"; Description = "Historical HNS/FNS state."; X = 11; Y = 67; W = 11; H = 8 },
    @{ Title = "Estimated data by destination access tier"; Path = "queries\tiles\16_data_by_storage_access_tier.kql"; Visual = "bar"; Description = "Historical XStore access tier."; X = 0; Y = 75; W = 11; H = 8 },
    @{ Title = "Estimated data by destination account class"; Path = "queries\tiles\17_data_by_storage_account_class.kql"; Visual = "bar"; Description = "Historical billing/account class."; X = 11; Y = 75; W = 11; H = 8 },
